            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        {{--</div>--}}
                        <form class="layui-form layui-col-space5" action="/admin/medialist" method="get">
                            ...
                            <table class="layui-table layui-form">
                                ...
                                @foreach($data as $k=>$v)
                                  <tr>
                                    ...
                                    <td>{{$v->url}}</td>
                                    <td class="td-manage">
                                      <a onclick="xadmin.open('修改','/admin/mediaupd/{{$v->id}}',600,400)" title="修改" href="javascript:;">
                                        <i class="layui-icon">&#xe631;</i>
                                      </a>
                                      <a title="删除" onclick="member_del(this,'')" href="/admin/mediadel/{{$v->id}}">
                                        <i class="layui-icon">&#xe640;</i>
                                      </a>
                                    </td>
                                  </tr>
