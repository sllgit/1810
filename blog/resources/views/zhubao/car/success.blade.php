...
<div class="maincont">
    ...
    <div class="dingdanlist">
        <table>
            <tr>
                <td width="50%">
                    <h3>订单号：<span id="order_no">{{$data->order_no}}</span></h3>
                    <time>创建日期：{{date("Y-m-d h:i:s",$data->create_time)}}<br />
                        失效日期：2015-9-12</time>
                    <strong class="orange">¥{{$allprice}}</strong>
                </td>
...
<div class="gwcpiao">
    <table>
        <tr>
            <td width="50%"><a href="/zhubao/allshop" class="jiesuan" style="background:#5ea626;">继续购物</a></td>
            <td width="50%"><a href="javascript:;" class="jiesuan gopay">立即支付</a></td>
        </tr>
    </table>
</div><!--gwcpiao/-->
</div><!--maincont-->
...
<script>
    $(function () {
        $('.gopay').click(function () {
           ...
           location.href="/zhubao/gopay/"+order_no;
        })
    })
</script>